 ...
 *   /node_modules/         the app's `node_modules`, so `capacitor-video-kit/...` in the import map
 ...
 * `node_modules/capacitor-video-kit` is a symlink back to this repository and what the page loads is
 ...
 * `node_modules/capacitor-video-kit` is followed on purpose and the real path is not what is checked,
