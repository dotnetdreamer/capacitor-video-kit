# capacitor-video-kit/vue

Vue bindings for the Capacitor Video Kit editor.

```sh
npm install ./capacitor-video-kit-1.3.0.tgz ./capacitor-video-kit/vue-1.3.0.tgz
```

```vue
<script setup lang="ts">
import { VeSpinner } from 'capacitor-video-kit/vue';
</script>
...
`capacitor-video-kit` at the exact version of this package, because the two are generated together and
